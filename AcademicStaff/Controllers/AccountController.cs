        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    else if (user.Status == Models.Entities.Status.Active)
                    {
                    ...
                    else if (user.Status == Models.Entities.Status.Inactive)
                    {
                        TempData["continue"] = "Your Account is Inactive.Contact the Administrator!";
                        return RedirectToAction("Login", "Account", new { area = ""});
                    }

                    else
                    {
                        TempData["continue"] = "Please complete your registration.";
                        return RedirectToAction("Register", "User", new { area = "Staff", userid = user.Id });
                ...
                //        else if (status.Status ==Models.Entities.Status.None)
                //        {
                //            return RedirectToAction("Register", "User", new { area = "Staff", userid = user.Id });
                //        }

                //        else if (status.Status == Models.Entities.Status.Inactive)
                //        {
                //            return RedirectToAction("Register", "User", new { area = "Staff", userid = user.Id });
                //        }
